...
of::common::uuid of::asset::Trait<of::resource::WorldInstance>::typeId = of::common::uuid("f57ee805-75e7-47ce-b852-d59a452c2338");
of::common::uuid of::asset::Trait<of::resource::ObjectChunk>::typeId = of::common::uuid("72f0e022-884a-4cc5-bc84-9a5f55cd9eb6");
...
namespace of::resource
{
	...
	of::asset::TypeInfo WorldInstance::getTrait() const
	{
		return { of::asset::Trait<WorldInstance>::typeId };
	}

	of::asset::TypeInfo ObjectChunk::getTrait() const
	{
		return { of::asset::Trait<ObjectChunk>::typeId };
	}
}