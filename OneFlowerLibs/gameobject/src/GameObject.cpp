...
namespace of::object
{
	...
	void GameObject::sendMessage(const common::String& msgType, const common::String& message)
	{
		msgType;
		message;
	}
	...
	void GameObject::onDelete()
	{
		...
		for (auto& component : componentMap)
		{
			logger.Debug("OnDelete Component Shared Ptr Addr -> " + common::toHex((size_t)&component.second));
			logger.Debug("OnDelete Component Addr -> " + common::toHex((size_t)component.second.get()));
