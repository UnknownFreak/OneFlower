...
namespace of::object::component
{
	...
	void Base::attachOn(GameObject* attachTo)
	{
		if (attachedOn)
		{
			engine::GetModule<of::logger::Logger>().getLogger("of::object::component").Debug("Component detached [ComponentType, instanceId]");
			engine::GetModule<of::logger::Logger>().getLogger("of::object::component").Debug(getTypeName(), ", ", instanceId);
			decouple();
		}
		...
		initialize();
		engine::GetModule<of::logger::Logger>().getLogger("of::object::component").Debug("Component initialized [ComponentType, instanceId]");
		engine::GetModule<of::logger::Logger>().getLogger("of::object::component").Debug(getTypeName(), ", ", instanceId);
	}
