...
std::map<unsigned, of::input::Controller> of::input::Controller::controllers;
bool of::input::Controller::getControllers = true;
of::input::Controller undefined = of::input::Controller(0xff, 0xff);
of::input::Controller& of::input::Controller::currentController = undefined;
