...
/*
template<typename T>
Vector2t<T>::Vector2t<T>(int a,int b):x(a),y(b)
{
}
//*/
...
template<typename T>
double Vector2t<T>::distance(Vector2t<T>* target)
{
...
double Vector2t<T>::angle(Vector2t<T>* target)
{
	...
	double angleInDegree = std::atan2(deltaY, deltaX) * 180 / 3.14159265358979323846;
