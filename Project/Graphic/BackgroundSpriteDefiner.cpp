...
{
	sprite.setTexture(Engine::GetModule<Asset::AssetManager>().textureloader.requestTexture(n));
...
BackgroundSprite& BackgroundSprite::operator=(const BackgroundSprite &BackgroundSprite)
{
	...
	sprite.setTexture(Engine::GetModule<Asset::AssetManager>().textureloader.requestTexture(name));
