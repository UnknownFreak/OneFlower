...
const unsigned int Component::IBaseComponent<Component::DialogComponent>::typeID = 1004;
Core::String Component::IBaseComponent<Component::DialogComponent>::componentName = "DialogComponent";
...
namespace Component
{
	...
	{
		DialogComponent::Base::attachOn(go);
	}
