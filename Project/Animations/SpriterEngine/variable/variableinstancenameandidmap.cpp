...
namespace SpriterEngine
{
	...
	UniversalObjectInterface *VariableInstanceNameAndIdMap::getVariable(size_t variableIndex)
	{
	...
	UniversalObjectInterface *VariableInstanceNameAndIdMap::getVariable(Core::String variableName)
	{
