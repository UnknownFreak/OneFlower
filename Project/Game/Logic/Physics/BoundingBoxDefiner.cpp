...
Physics::BoundingBox::BoundingBox(int x,int y,int w,int h): position(x,y),size(w,h)
{
		
}
Physics::BoundingBox::BoundingBox(Vector2 pos,Vector2 siz) : position(pos),size(siz)
{}
