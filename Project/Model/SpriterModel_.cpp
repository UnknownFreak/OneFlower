...
namespace Model
{
	...
	{
		myEntity = Engine::GetModule<SpriterInstanceContainer>().requestModel(fileName, selectedModelName, textureMapId, m_render_sprite);
	}
	...
	{
		myEntity->setTimeElapsed(update_ms/10.0f);
