...
namespace SpriterEngine
{
	...
	point BoneObjectInfo::getPosition() const
	{
		return position;
	}

	real BoneObjectInfo::getAngle() const
	{
		return angle.angle;
	}

	point BoneObjectInfo::getScale() const
	{
		return scale;
	}

	real BoneObjectInfo::getAlpha() const
	{
		return alpha;
	}
	...
	void BoneObjectInfo::setSpin(s_int newSpin)
	{
