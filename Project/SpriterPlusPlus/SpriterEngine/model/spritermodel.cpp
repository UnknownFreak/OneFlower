...
{
	SpriterModel::SpriterModel(const Core::String & fileName, FileFactory * newFileFactory, ObjectFactory * newObjectFactory, SpriteRef*& sprite) :
		SpriterModel(newFileFactory, newObjectFactory, sprite)
	{
		loadFile(fileName);
	}

	SpriterModel::SpriterModel(FileFactory * newFileFactory, ObjectFactory * newObjectFactory, SpriteRef*& sprite) :
	...
	EntityInstance * SpriterModel::getNewEntityInstance(Core::String entityName, SpriteRef*& sprite)
	{
		_sprite = sprite;
		for (auto& it : entities)
		{
