...
namespace SpriterEngine
{
	...
	{
	public:
		SpriterModel(const Core::String &fileName, FileFactory *newFileFactory, ObjectFactory *newObjectFactory, SpriteRef*& sprite);
		SpriterModel(FileFactory *newFileFactory, ObjectFactory *newObjectFactory, SpriteRef*& sprite);
		~SpriterModel();

		EntityInstance *getNewEntityInstance(s_int entityId);
		EntityInstance *getNewEntityInstance(EntityIdVector *entityIds);
		EntityInstance *getNewEntityInstance(Core::String entityName, SpriteRef*& sprite);
