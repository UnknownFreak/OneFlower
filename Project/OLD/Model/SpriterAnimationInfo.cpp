...
SpriterAnimationInfo::SpriterAnimationInfo(SpriterEngine::EntityInstance * instance, double currentAnimationTime, Core::String currentAnimation) :
...
void SpriterAnimationInfo::updateFrame(const size_t& update_ms)
{
	...
	currentAnimationTime += update_ms / 10.0;
