...
of::common::uuid Interfaces::Trait<File::Asset::Resource::Template::WorldInstance>::typeId = of::common::uuid("f57ee805-75e7-47ce-b852-d59a452c2338");
of::common::uuid Interfaces::Trait<File::Asset::Resource::Template::ObjectChunk>::typeId = of::common::uuid("72f0e022-884a-4cc5-bc84-9a5f55cd9eb6");
