...
Core::uuid Interfaces::Trait<WorldInstance>::typeId = Core::uuid("f57ee805-75e7-47ce-b852-d59a452c2338");
Core::uuid Interfaces::Trait<ObjectChunk>::typeId = Core::uuid("72f0e022-884a-4cc5-bc84-9a5f55cd9eb6");
