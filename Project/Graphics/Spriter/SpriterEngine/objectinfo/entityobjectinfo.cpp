...
namespace SpriterEngine
{
	...
	point EntityObjectInfo::getPosition() const
	{
		return position;
	}

	real EntityObjectInfo::getAngle() const
	{
		return angle.angle;
	}

	point EntityObjectInfo::getScale() const
	{
		return scale;
	}

	real EntityObjectInfo::getAlpha() const
	{
		return alpha;
	}
	...
	void EntityObjectInfo::setSpin(s_int newSpin)
	{
