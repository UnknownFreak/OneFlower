...
namespace SpriterEngine
{
	...
	point BoneInstanceInfo::getPosition() const
	{
		return position;
	}

	real BoneInstanceInfo::getAngle() const
	{
		return angle.angle;
	}

	point BoneInstanceInfo::getScale() const
	{
		return scale;
	}

	real BoneInstanceInfo::getAlpha() const
	{
		return alpha;
	}

	point BoneInstanceInfo::getSize() const
	{
		return size;
	}
