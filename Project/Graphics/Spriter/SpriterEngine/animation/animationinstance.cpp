...
namespace SpriterEngine
{
	...
	s_int AnimationInstance::currentMainlineKeyIndex()
	{
	...
	{
		s_int oldIndex = currentMainlineKeyIndex();
		s_int newIndex = oldIndex + 1;
		if (isLooping)
		{
	...
	void AnimationInstance::setCurrentTimeToKeyAtIndex(s_int newIndex, ObjectInterfaceVector **instanceZOrder)
	{
		MainlineKeyInstance *mainKey = mainlineKeyAtIndex(newIndex);
		if (mainKey)
		{
	...
	s_int AnimationInstance::mainlineKeyCount()
	{
	...
	MainlineKeyInstance * AnimationInstance::mainlineKeyAtIndex(s_int index)
	{
